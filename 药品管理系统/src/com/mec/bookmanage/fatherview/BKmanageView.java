...
//		jPanel1.setBackground(Color.red);
		...
		jLabel = new JLabel("药品销售管理系统",jLabel.CENTER);
	...
	//--------------------------------------------------------------------------	
		...
		jPanel2  = new JPanel() {
			public void paintComponent(Graphics g) {
                ImageIcon icon =new ImageIcon("D:\\测试用图\\7.png");
...
//		jPanel2.setBackground(Color.LIGHT_GRAY);
		...
		jButton1 = new JButton("出售药品/购买药品");
...
//		jButton6.setBackground(Color.RED);
		...
		jLabel2 = new JLabel("Hello doctor");
