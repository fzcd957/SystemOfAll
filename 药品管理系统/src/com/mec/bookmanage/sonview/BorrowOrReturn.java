...
public class BorrowOrReturn implements IBKmanageView{
	...
	public void init() {
		...
		jLabel = new JLabel("购买药品/出售药品",JLabel.CENTER);
		...
		jLabel1 = new JLabel("药品编号:",JLabel.RIGHT);
		...
		jLabel2 = new JLabel("操作员姓名:",JLabel.RIGHT);
		...
		jButton1 = new JButton("购  买");
		jButton1.setBounds(300, 10, 100, 30);
		jPanel3.add(jButton1);
		
		jButton2 = new JButton("出  售");
	...
	public void dealAction() {
		jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				bw.setSTtime(T);
				query.save(bw);		
				query.update(BookModel.class, "已被购买", bkid);
		...
		jButton2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(query.getbyid(BorrowModel.class, bkid, ppname) != null) {
					query.update(BookModel.class, "未被购买", bkid);
