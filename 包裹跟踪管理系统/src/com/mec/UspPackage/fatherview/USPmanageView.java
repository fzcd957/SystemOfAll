...
import com.mec.UspPackage.sonview.AddPackage;
import com.mec.UspPackage.sonview.Allinfo;
import com.mec.UspPackage.sonview.Getinfo;
import com.mec.UspPackage.sonview.Help;

public class USPmanageView extends Thread implements IBKmanageView{
	...
	public void init() {
		...
		jPanel1 = new JPanel() {
			public void paintComponent(Graphics g) {
                ImageIcon icon =new ImageIcon("D:\\测试用图\\package1.jpg");
...
//		jPanel1.setBackground(Color.red);
		...
		jLabel = new JLabel("USP包裹跟踪系统",jLabel.CENTER);
	...
	//--------------------------------------------------------------------------	
		...
		jPanel2  = new JPanel() {
			public void paintComponent(Graphics g) {
                ImageIcon icon =new ImageIcon("D:\\测试用图\\package3.jpg");
