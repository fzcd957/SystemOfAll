...
public class Query {
	...
	public int update3ById(Class<?> klass,Object object1,Object object2) {
		ClassTableDefinition ctd = ClassTableFactory.getClassTable(klass);
		if (ctd == null) {
			return 0;
		}
		String SQLString = new Expression().update3ById(ctd);
		try {
			Connection connection = DataSource.getConneciton();
			PreparedStatement state = connection.prepareStatement(SQLString);
	...
	public int update1ById(Class<?> klass,Object object1,Object object2) {
		ClassTableDefinition ctd = ClassTableFactory.getClassTable(klass);
		if (ctd == null) {
			return 0;
		}
		String SQLString = new Expression().update1ById(ctd);
		try {
			Connection connection = DataSource.getConneciton();
			PreparedStatement state = connection.prepareStatement(SQLString);
	...
	public int update2ById(Class<?> klass,Object object1,Object object2) {
		ClassTableDefinition ctd = ClassTableFactory.getClassTable(klass);
		if (ctd == null) {
			return 0;
		}
		String SQLString = new Expression().update2ById(ctd);
		try {
			Connection connection = DataSource.getConneciton();
			PreparedStatement state = connection.prepareStatement(SQLString);
