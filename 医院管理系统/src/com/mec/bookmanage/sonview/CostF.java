...
public class CostF implements IBKmanageView {
	...
	public void init() {
		...
		jLabel = new JLabel("划  价",JLabel.CENTER);
		jLabel.setBounds(0,0,800,80);
		jLabel.setFont(topicFont);
		jPanel.add(jLabel);
		
		jLabel1 = new JLabel("  输入病历号:  ");
	...
	public void dealAction() {
		jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				CostModel info = query.get(CostModel.class, ppnumber);
				if(info == null) {
					Error2 er = new Error2();
					er.showView();
				}
				else {
					Cost it = new Cost(info);
					it.showView();
