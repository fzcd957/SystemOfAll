...
public class Getmoney implements IBKmanageView {
	...
	public void init() {
		...
		jLabel = new JLabel("收  费",JLabel.CENTER);
	...
	public void dealAction() {
		jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String a = jTextField.getText().toString();
				
				query.update3ById(Cost.class, "已缴费", a);
				new Success3().showView();
			}
		});
